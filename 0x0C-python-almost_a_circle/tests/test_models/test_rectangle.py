...
'''
    Run test cases for the Rectangle module
'''
...
class test_rectangle(unittest.TestCase):
    ...
    def test_width(self):
        '''
            Test the Rectangle width getter
        '''
        self.assertEqual(5, self.r.width)

    def test_height(self):
        '''
            Test the Rectangle height getter
        '''
        self.assertEqual(10, self.r.height)

    def test_x(self):
        '''
            Test Rectangle x getter and setter
        '''
    ...
    def test_y(self):
        '''
            Test Rectangle y getter and setter
        '''
